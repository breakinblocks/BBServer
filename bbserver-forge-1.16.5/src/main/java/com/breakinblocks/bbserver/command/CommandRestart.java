        ...
        dispatcher.register(Commands.literal("restart")
                ...
                .executes(context -> {
                    if (Restart.restarting) {
                        context.getSource().sendFailure(new StringTextComponent("Server is already restarting!"));
                        return 0;
                    }
                    ...
                    try {
                        ...
                        context.getSource().sendFailure(new StringTextComponent("Failed to create the restart flag file."));
                        return 0;
                    }
